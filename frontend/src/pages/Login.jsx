    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div className="login-providers">
          <a href={`${API}/auth/google/login`} className="btn-provider btn-google">
          ...
          <a href={`${API}/auth/github/login`} className="btn-provider btn-github">
          ...
          <a href={`${API}/auth/facebook/login`} className="btn-provider btn-facebook">
